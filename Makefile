...
SRCS		= $(I_SALES_C) $(RO_STOCK_C) $(RO_PURCHASE_C) $(HA_PRODUCT_C) $(HA_POINT_C) $(NI_CUSTOMER_C) $(NI_SALESTOTAL_C) $(HO_SALESANARYZE_C) $(HO_ABCANARYZE_C) pos_main.c login.c common_func.c setup_connect.c
